...
if (body.offsetWidth <= 610){
  content.style = `
    transform: translate3d(${30}px, -${body.offsetHeight*0.9}px, 0px);
  `
  gr_wrapper.style = `
  ...
  content.style = `
    transform: translate3d(${body.offsetWidht/8}px, -${body.offsetHeight*1.25}px, 0px);
  `
  ...
  content.style = `
    ...
    transform: translate3d(0px, -${(content.offsetHeight)+(body.offsetHeight/1.5)}px, 0px);
